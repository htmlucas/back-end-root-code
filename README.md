...
## Decisões e premissas
  ...
  - Utilizei colunas json tanto em avisos como participantes para ser mais rápido, mas daria para criar uma tabela participantes relacionado a cotação (ou a viagem,dependendo do modelo)